    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmedit" action="{{ route('updateanalytic', $analytic->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="campaignName">Views</label>
                                        <input type="number" class="form-control" id="views" name="views" value="{{ $analytic->views }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="campaignBudget">clicks</label>
                                        <input type="number" class="form-control" id="clicks" name="clicks" value="{{ $analytic->clicks }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="startDate">Date</label>
                                        <input type="date" class="form-control" id="date" name="date" value="{{ $analytic->date }}" required>
                                    </div>
                                </div>
                               
                              
                            </div>
                            <button class="btn btn-submits btn-primary my-5"> Add Analytic </button>
                        </div>
                    </div>
                </form>
