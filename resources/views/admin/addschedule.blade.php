...
<html lang="en">
  <head>
    ...
    <title>Entertainment Directory - Add Campaign </title>
    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ route('schedule.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Ad Schedule </h3>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            ...
                            <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="userId">Ad</label>
                                        <select class="form-control" name="ad_id" id="adId">
                                            <option value="">Select a Ad</option>
                                            @foreach ($ad as $ad)  <!-- Assuming $users is passed from the controller -->
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position_id" id="positionId">
                                            <option value="">Select a Position</option>
                                            @foreach ($position as $position)  <!-- Assuming $users is passed from the controller -->
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" id="startDate" name="start_time" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="endDate">End Time</label>
                                        <input type="datetime-local" class="form-control" id="endDate" name="end_time" required>
                                    </div>
                                </div>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Add Campaign </button>
                        </div>
                    </div>
                </form>
