    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmedit" action="{{ route('updateschedule', $schedule->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $schedule['id'] }}">
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Edit schedule </h3>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="row gy-4">
                              <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ad_id" id="user">
                                            ...
                                            @foreach ($ad as $ad)
                                                <option value="{{ $ad->id }}" {{ $ad->id == $schedule->ad_id ? 'selected' : '' }}>
                                                    {{ $ad->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position_id" id="user">
                                            ...
                                            @foreach ($position as $position)
                                                <option value="{{ $position->id }}" {{ $position->id == $schedule->position_id ? 'selected' : '' }}>
                                                    {{ $position->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" id="startDate" name="start_time" value="{{ $schedule->start_time }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="endDate">End Time</label>
                                        <input type="datetime-local" class="form-control" id="endDate" name="end_time" value="{{ $schedule->end_time }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="campaignStatus" name="status" required>
                                            ...
                                            <option value="running" {{ $schedule->status == 'running' ? 'selected' : '' }}>Running</option>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Update Campaign </button>
                        </div>
                    </div>
                </form>
