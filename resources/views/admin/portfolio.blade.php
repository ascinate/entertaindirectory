        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Listings </h3>
                    <a href="{{ url ('portfolio/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Portfolio </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Portfolio </h3>
                    <a href="{{ URL::to('addlisting')}}" class="btn btn-amds ms-3"> <i class="ri-add-line"></i> Add Portfolio  </a>
                 </div>
                    ...
                    <tbody>
                      @foreach ($portfolio as $portfolio)
                        <tr>
                            ...
                            <td>{{ $portfolio->media_type }}</td>
                            <td><img src="{{ asset('uploads/' . $portfolio->media_files) }}" alt="Media" width="100"></td>
                            <td>
                            <a href="{{ route('editportfolio', $portfolio->id) }}" class="btn btn-warning btn-sm">
                            ...
                            <a href="{{ route('deleteportfolio', $portfolio->id) }}" class="btn btn-danger btn-sm">
