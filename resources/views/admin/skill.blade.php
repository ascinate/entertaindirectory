        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Skills </h3>
                    <a href="{{ url ('skill/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Skills </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Skills </h3>
                 </div>
                      ...
                      @foreach ($skill as $skill)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('editskill', $skill->id) }}" class="btn btn-sm btn-warning" style="padding: 5px;">
                                ...
                                <a href="{{ route('deleteskill', $skill->id) }}" class="btn btn-sm btn-danger" style="padding: 5px;" onclick="return confirm('Are you sure you want to delete this skill?');">
