    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ route('trans.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Add Transaction </h3>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="amount" name="total_amount" required>
                                    </div>
                                </div>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Add Transaction </button>
                        </div>
                    </div>
                </form>
