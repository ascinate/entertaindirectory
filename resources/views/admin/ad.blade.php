        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Ad Sample </h3>
                    <a href="{{ url ('ad/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Sample </a>
                </div>
                @if (session('success'))
               ...
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Advertisment </h3>
                 </div>
                        ...
                        <tbody>
                            @foreach ($ads as $ad)
                                <tr>
                                    ...
                                    <td>{{ $ad->ad_page }}</td>
                                    <td><img src="{{ asset('uploads/' .$ad->image) }}" alt="Ad Image" style="width: 100px; height: auto;"></a></td>
                                    <td>{{ $ad->ad_price }}</td>
                                    <td>{{ $ad->ad_duration  }}</td>
                                    <td>{{ $ad->description ?? 'N/A' }}</td>
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('editad', $ad->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('deletead', $ad->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this ad?');">
