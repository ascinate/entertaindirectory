        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Categories </h3>
                    <a href="{{ URL::to('addquestions') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Question </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                  <div class="tansb comiut-tabs crm-tables crm-tables-new mt-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @foreach($questions as $index => $question)
                                        ...
                                        @endif
                                        <td>
                                            <h6 class="h6"><strong>{{ $question->question }}</strong></h6>
                                        </td>
                                        <td>
