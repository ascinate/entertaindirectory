    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ URL::to('addquestion') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                        ...
                        <div class="tansb comiut-tabs crm-tables news-details-post mt-4">
                            ...
                            <div class="row gy-4">
                                                ...
                                                @php
                                                    function renderCategoryOptions($categories, $level = 0) {
                                                                foreach ($categories as $category) {
                                                                    ...
                                                                    echo '<input type="radio" class="radio" id="category-' . $category->id . '" name="category_id" value="' . $category->id . '" />';
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select" name="field_type" aria-label="Default select example">
...
jQuery(document).ready(function($) {
    ...
    const hiddenInput = $("#selected_category_id");
