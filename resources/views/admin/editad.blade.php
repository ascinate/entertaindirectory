...
<html lang="en">
  <head>
    ...
    <title>Entertainment - Add listings </title>
    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmedit" action="{{ route('updatead', $ad->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $ad->id }}">
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Edit Sample </h3>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            ...
                            <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ad_title" name="ad_title" value="{{ $ad->ad_title }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="adName">Ad Size</label>
                                        <select class="form-control" id="ad_size" name="ad_size" required>
                                            <option value="">Select Ad Size</option>
                                            <option value="1243 X 250 PX" {{ $ad->ad_size == '1243 X 250 PX' ? 'selected' : '' }}>1243 X 250 PX</option>
                                            <option value="300 X 265 PX" {{ $ad->ad_size == '300 X 265 PX' ? 'selected' : '' }}>300 X 265 PX</option>
                                            <option value="344 X 307 PX" {{ $ad->ad_size == '344 X 307 PX' ? 'selected' : '' }}>344 X 307 PX</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="ad_position" name="ad_position" required>
                                            ...
                                            <option value="Before Blogpost" {{ $ad->ad_position == 'Before Blogpost' ? 'selected' : '' }}>Before Blogpost</option>
                                            <option value="After Filter" {{ $ad->ad_position == 'After Filter' ? 'selected' : '' }}>After Filter</option>
                                            <option value="After Sidebar" {{ $ad->ad_position == 'After Sidebar' ? 'selected' : '' }}>After Sidebar</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="ad_page" name="ad_page" required>
                                            <option value="">Select Ad Page</option>
                                            <option value="Home" {{ $ad->ad_page == 'Home' ? 'selected' : '' }}>Home</option>
                                            <option value="Performer Listing" {{ $ad->ad_page == 'Performer Listing' ? 'selected' : '' }}>Performer Listing</option>
                                            <option value="Performer Details" {{ $ad->ad_page == 'Performer Details' ? 'selected' : '' }}>Performer Details</option>
                                            <option value="Ads" {{ $ad->ad_page == 'Ads' ? 'selected' : '' }}>Ads</option>
                                            <option value="Blog" {{ $ad->ad_page == 'Blog' ? 'selected' : '' }}>Blog</option>
                                            <option value="Contact" {{ $ad->ad_page == 'Contact' ? 'selected' : '' }}>Contact</option>
                                            <option value="FAQ" {{ $ad->ad_page == 'FAQ' ? 'selected' : '' }}>FAQ</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        @if($ad->image)
                                            <img src="{{ asset('uploads/' . $ad->image) }}" alt="Ad Image" class="img-thumbnail mt-2" style="width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ad_price" name="ad_price" value="{{ $ad->ad_price }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="asDuration">Ad Duration</label>
                                        <input type="text" class="form-control" id="ad_duration" name="ad_duration" value="{{ $ad->ad_duration }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Update Sample </button>
                        </div>
                    </div>
                </form>
