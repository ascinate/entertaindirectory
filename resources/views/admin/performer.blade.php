        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Performer </h3>
                    <a href="{{ url ('performer/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Performer </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Performer </h3>
                 </div>
                        ...
                        <tr>
                            <td>
                                  @if ($user->profile_photo)
                                      <img src="{{ asset('profile_photo/' . $user->profile_photo) }}" alt="Profile Photo" style="width: 100px; height: auto;">
                                  @else
                                      <span>No Photo</span>
                                  @endif
                            </td>
                            ...
                            <td class="text-center">
                                <!-- Edit Button -->
                                <a href="{{ route('editperformer', $user->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                ...
                                <!-- Delete Button -->
                                <a href="{{ route('deleteperformer', $user->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this user?');">
