...
<html lang="en">
  <head>
    ...
    <title>University marketplace - Add listings </title>
    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ URL::to('addlist') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Add listings </h3>
                        </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex bodre-tops align-items-center">
                                            <input type="text" class="form-control" name="price" required/>
                                            <span class="dollers ms-2"><strong>$</strong></span>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="validationCustom01" class="form-label">Photos</label>
                                        <input class="form-control" type="file" id="files" name="photos[]"  multiple>
                                    </div>
                                </div>
                            </div>
                            <button class="btn btn-submits btn-primary my-5"> Add listing </button>
                        </div>
