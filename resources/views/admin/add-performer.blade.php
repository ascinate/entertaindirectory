    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ route('performer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Add Performer </h3>
                        </div>
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            <div class="row gy-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="skills">
                                            ...
                                            @foreach ($skill as $skillOption)
                                                <option value="{{ $skillOption->id }}" {{ old('skill') == $skillOption->id ? 'selected' : '' }}>
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-submits btn-primary my-5">Add User</button>
                                </div>
                            </div>
                        </div>
                    </div>
