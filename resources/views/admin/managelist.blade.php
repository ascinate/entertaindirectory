        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Listings </h3>
                    <a href="{{ URL::to('addlisting')}}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Listings </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage listings </h3>
                    <a href="{{ URL::to('addlisting')}}" class="btn btn-amds ms-3"> <i class="ri-add-line"></i> Add Listings  </a>
                 </div>
