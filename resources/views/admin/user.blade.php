        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Users </h3>
                    <a href="{{ url ('user/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add User </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage User </h3>
                 </div>
                      ...
                      @foreach ($user as $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- Edit Button -->
                                <a href="{{ route('edituser', $user->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                ...
                                <!-- Delete Button -->
                                <a href="{{ route('deleteuser', $user->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this user?');">
