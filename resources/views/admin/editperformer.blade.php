    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmedit" action="{{ route('updateperformer', $user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Edit Performer </h3>
                        </div>
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if($user->profile_photo)
                                            <img src="{{ asset('profile_photo/' . $user->profile_photo) }}" alt="Profile Photo" class="img-thumbnail mt-2" style="width: 100px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="skills">
                                            ...
                                            @foreach ($skill as $skillOption)
                                                <option value="{{ $skillOption->id }}" {{ $user->skill == $skillOption->id ? 'selected' : '' }}>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Update User </button>
                        </div>
                    </div>
                </form>
