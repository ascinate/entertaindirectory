        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Events </h3>
                    <a href="{{ url ('event/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Events </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Events </h3>
                 </div>
                      ...
                      @foreach ($event as $event)
                        <tr>
                            ...
                            <td>
                                ...
                                @endphp
                                @if (!empty($images[0])) 
                                    <img src="{{ asset('uploads/' . $images[0]) }}" alt="Event Image" style="width: 50px; height: 50px; object-fit: cover;">
                                @else
                                    <span>No Image</span>
                                @endif 
                                </td>
                            ...
                            <td>{{ $event->date }}</td>
                            <td>
                            <a href="{{ route('editevent', $event->id) }}" class="btn btn-warning btn-sm">
                            ...
                            <a href="{{ route('deleteevent', $event->id) }}" class="btn btn-danger btn-sm">
