        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Analytic </h3>
                    <a href="{{ url ('analytic/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Analytic </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Analytic </h3>
                 </div>
                        ...
                        <tbody>
                            @foreach ($analytics as $analytic)
                                <tr>
                                    ...
                                    <td>{{ number_format($analytic->clicks, 2) }}</td>
                                    <td>{{ $analytic->date }} </td>
                                      
                                    
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('editanalytic', $analytic->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('deleteanalytic', $analytic->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this campaign?');">
