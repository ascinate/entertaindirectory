    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmedit" action="{{ route('updatetrans', $transaction->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $transaction->id }}">
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Edit Transaction </h3>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="buyer_id" id="user" >
                                            <option value="">Select User</option>
                                            @foreach ($user as $user)
                                                <option value="{{ $user->id }}" {{ $user->id == $transaction->buyer_id ? 'selected' : '' }}>
                                                    {{ $user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="user">Ad</label>
                                        <select class="form-control" name="ad_id" id="user" >
                                            <option value="">Select Ad</option>
                                            @foreach ($ad as $ad)
                                                <option value="{{ $ad->id }}" {{ $ad->id == $transaction->ad_id ? 'selected' : '' }}>
                                                    {{ $ad->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="position_id" id="user" >
                                            <option value="">Select Position</option>
                                            @foreach ($position as $position)
                                                <option value="{{ $position->id }}" {{ $position->id == $transaction->position_id ? 'selected' : '' }}>
                                                    {{ $position->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="amount" name="total_amount" value="{{ $transaction->total_amount }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="transactionDate" name="start_date" value="{{ $transaction->start_date }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="transactionDate" name="ens_date" value="{{ $transaction->end_date }}" required>
                                    </div>
                                </div>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Update Transaction </button>
                        </div>
                    </div>
                </form>
