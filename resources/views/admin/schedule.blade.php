...
<html lang="en">
  <head>
    ...
    <title>Entertainment - Manage listings </title>
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3>  Schedule </h3>
                    <a href="{{ url ('schedule/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Schedule </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Schedule </h3>
                 </div>
                 <div class="d-flex align-items-center col-lg-3 mt-3">
                    ...
                    <a href="#" class="btn btn-amds2 ms-3"> Apply  </a>
                 </div>
                 <div class="tansb comiut-tabs crm-tables mt-4">
                    <table id="example-datea-t1" class="table table-bordered table-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Ad Name</th>
                                <th>Position Name</th>
                        ...
                        <tbody>
                            @foreach ($schedule as $schedule)
                                <tr>
                                <td>{{ $schedule->ad_name }}</td>
                                <td>{{ $schedule->position_name }}</td>
                                    <td>
                                        <span class="badge 
                                            {{ $schedule->status == 'active' ? 'bg-success' : ($schedule->status == 'paused' ? 'bg-warning' : 'bg-secondary') }}">
                                            {{ ucfirst($schedule->status) }}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('editschedule', $schedule->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                <path d="M12.854.146a.5.5 0 0 1 .11.638l-.07.085L5.021 8.5H3.5a.5.5 0 0 1-.492-.41L3 8V6.5l7.646-7.646a.5.5 0 0 1 .708 0zM4 9h-.5a.5.5 0 0 1-.492-.41L3.5 8.5h.978l5.646-5.646.707.707-5.646 5.646H4zm6.854-6.646-1-1L11 2.5l1 1L10.854 2.5z"/>
                                            </svg>
                                        </a>

                                        <!-- Delete Button -->
                                        <a href="{{ route('deleteschedule', $schedule->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this campaign?');">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                                <path d="M2.5 1a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1H15a1 1 0 0 1 0 2H1a1 1 0 0 1 0-2h1.5zm1.639 3H12.5a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H3.5a1 1 0 0 1-1-1v-9a1 1 0 0 1 1-1h.639l.643-.707A1 1 0 0 1 5.61 3h4.78a1 1 0 0 1 .828.293l.643.707zm1.5 2v7h.5v-7h-1zm4 0v7h.5v-7h-1z"/>
                                            </svg>
                                        </a>
                                    </td>
                                </tr>
