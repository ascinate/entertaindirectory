        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Position </h3>
                    <a href="{{ url ('position/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Position </a>
                </div>
               
                
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Position </h3>
                 </div>
                    ...
                    <table id="example-datea-t1" class="table table-bordered table-striped nowrap" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($positions as $position)
                                <tr>
                                    <td>{{ $position->name }}</td>
                                    <td>{{ number_format($position->price_per_day , 2) }}</td>
                                    <td>{{ $position->dimensions }} </td>
                                    <td>{{ $position->description }} </td>   
                                    
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('editposition', $position->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('deleteposition', $position->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this campaign?');">
