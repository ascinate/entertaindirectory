    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ route('updateevent' , $event->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="id" value="{{ $event['id'] }}">
                    <div class="righty-divu spo-apce py-4">
                        <div class="d-flex align-items-center">
                            <h3 class="ms-sub"> Edit Events </h3>
                        </div>
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    <label for="exampleInputPortfolioImage">Event Title</label>
                                    <input type="text" class="form-control" name="event_title" placeholder="Event Title" value="{{ $event->event_title }}" >
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    <label for="exampleInputPortfolioImage">Event Type</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    <label for="exampleInputPortfolioImage">Date</label>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Add Events </button>
                        </div>
