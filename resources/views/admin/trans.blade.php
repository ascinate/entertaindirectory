        ...
        <div class="features-body min-height">
            <div class="headiering-steps">
                ...
                <div class="headings-setps bg-white py-3 d-flex align-items-center justify-content-between">
                    <h3> Transaction </h3>
                    <a href="{{ url ('trans/create') }}" class="btn btn-suc"> <i class="ri-add-line"></i> Add Transaction </a>
                </div>
                @if (session('success'))
               ...
               <div class="righty-divu spo-apce py-4">
                 <div class="d-flex align-items-center">
                    <h3 class="ms-sub"> Manage Transaction </h3>
                 </div>
                        ...
                        <tbody>
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td>{{ $transaction->ad_name }}</td>
                                    <td>{{ $transaction->position_name }}</td>
                                    <td>{{ $transaction->total_amount }}</td>
                                    <td>
                                        <span class="badge 
                                            {{ $transaction->status == 'completed' ? 'bg-success' : 'bg-secondary' }}">
                                            {{ ucfirst($transaction->payment_status) }}
                                        </span>
                                    </td>
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('edittrans', $transaction->id) }}" class="btn btn-warning btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;">
                                        ...
                                        <!-- Delete Button -->
                                        <a href="{{ route('deletetrans', $transaction->id) }}" class="btn btn-danger btn-sm d-inline-flex align-items-center" style="padding: 5px 10px; font-size: 14px;" onclick="return confirm('Are you sure you want to delete this transaction?');">
