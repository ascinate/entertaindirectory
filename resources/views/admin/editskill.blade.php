    ...
    <section class="body-part01 right-bd-admin float-end">
        ...
        <div class="features-body min-height">
            ...
            <div class="headiering-steps">
                ...
                <form name="frmadd" action="{{ route('updateskill' , $skill->id) }}" method="POST">
                        ...
                        <div class="tansb froms-inputs comiut-tabs crm-tables mt-4">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label for="exampleInputPortfolioImage">Skill Name</label>
                            ...
                            <button class="btn btn-submits btn-primary my-5"> Update Skills </button>
